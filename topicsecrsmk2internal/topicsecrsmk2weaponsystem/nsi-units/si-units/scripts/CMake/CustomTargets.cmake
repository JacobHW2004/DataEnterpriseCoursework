...
function(lca_target_minimum_links Component)
    ...
    if("${NOT_USING_LCA_INCLUDES}" STREQUAL "true")
        message("NOT_USING_LCA_INCLUDES: ${NOT_USING_LCA_INCLUDES}")
    else()
        message("USING_LCA_INCLUDES: ${NOT_USING_LCA_INCLUDES}")
        target_link_libraries (${ContainerName}_${Component}LCA PRIVATE LCA_Container_Includes) # For LCA Container Context Instance
    endif()
