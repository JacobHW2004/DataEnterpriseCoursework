#pragma once
#ifndef STANAG_4607_SENSOR_ORIENTATION_H
#define STANAG_4607_SENSOR_ORIENTATION_H
...
namespace Topics{
	namespace Stanag4607Topics {
		...
		class Stanag4607_SensorOrientation
		{
		private:
			BA16_Angle heading{};
			SA16_Angle pitch{};		
		...
		public:
			Stanag4607_SensorOrientation() = default;

			Stanag4607_SensorOrientation(BA16_Angle heading, SA16_Angle pitch, SA16_Angle roll) :
				heading(heading),
				pitch(pitch),
				roll(roll) {}
			...
			LCA_TOPIC("Stanag4607_SensorOrientation", 1, 0);
		};	
	}
}
#endif