#pragma once
#ifndef STANAG_4607_SENSOR_POSITION_H
#define STANAG_4607_SENSOR_POSITION_H
...
namespace Topics{
	namespace Stanag4607Topics {
		//Represents sensor position data used by the STANAG 4607 format
		class Stanag4607_SensorPosition
		{
		private:
			SA32_Angle latitude{};
		...
		public:
			Stanag4607_SensorPosition() = default;

			Stanag4607_SensorPosition(SA32_Angle latitude, BA32_Angle longitude, int32_t altitude) :
				latitude(latitude),
				longitude(longitude),
				altitude(altitude){}
			...
			LCA_TOPIC("Stanag4607_SensorPosition", 1, 0);
		};	
	}
}
#endif